...
/** @file source.h These are pretend file-level comments.
 */
 ...
 */
     ...
     * 
     * This has fixed *emphatic* in inline doc uri. This piece is from the
     * explicit cache "Piece of Cache." it has no path.
     * 
